...
describe(`#validate() one rule without fields`, function() {
...
describe(`#validate() rule with fields: primitive, js data type, class`, function() {
  const te = new TypeEnforcement({
    test: {
      s: String,
      a: Array,
...
describe(`#normalise() one rule without fields`, function() {
  const te = new TypeEnforcement({
    test: {}
  });
...
describe(`#normalise() rule with fields: primitive, js data type, class`, function() {
  const te = new TypeEnforcement({
    test: {
      s: String,
      a: Array,
